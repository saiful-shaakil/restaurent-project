...
const PlaceOrder = () => {
  ...
  return (
    <div className="flex justify-around mt-20 w-full">
      <div className="w-96">
        <h1 className="text-3xl mt-8 font-popins underline font-semibold mb-10">
          Edit your details
        </h1>
        <form onSubmit={handleSubmit(onSubmit)}>
          <input
            type="text"
            class="block border font-popins border-grey-light w-full p-3 rounded"
            name="fullname"
            id="name"
      ...
      <div>
        <div className="flex font-popins flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-900 dark:text-gray-100">
          <h2 className="text-xl mt-0 font-semibold">Your cart</h2>
