  ...
  return (
    ...
    >
      <div className="hero-content flex-col lg:flex-row-reverse text-center">
        <div>
          <h1 className="sm:text-5xl text-3xl font-bold font-popins">
            We're Always Serious About <br /> Food &amp; Delivery
          </h1>
          <p className="py-6 font-popins text-xs sm:text-xl">
            Best cooks and best delivery guys is always at your service. Hot
            tasty food will reach you in 60 minutes.
            {/* search fiels */}
            <div className="flex items-center justify-center">
              <fieldset className="w-[200px] md:w-[400px] mt-2 space-y-1 border-2 rounded-lg  dark:text-gray-100">
                <div className="flex">
                  <input
                    type="text"
                    name="search"
                    ...
                    className="flex bg-transparent text-black flex-1 py-2 px-2  text-left text-sm rounded-lg focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400"
                  />
