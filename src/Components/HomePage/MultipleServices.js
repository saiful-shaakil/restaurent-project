...
import chef from "../../assets/images/chef-cook-food-33614.png";

const MultipleServices = () => {
  return (
    <div className="max-w-screen-xl px-10 font-popins bg-white dark:bg-gray-800 mx-auto py-4 sm:px-6 lg:px-8 relative py-26 lg:mt-20">
